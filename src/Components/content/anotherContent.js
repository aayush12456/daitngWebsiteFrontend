    ...
    <>
      <div className="lg:flex lg:justify-center lg:mt-8 dateLocal  ">
        ...
        <div className="w-screen rounded lg:w-[40rem] bg-[#eff0f4]   ">
          ...
          <img src={forwardArrow} className="hidden w-12 -mt-2 ml-4 lg:block "/>
          <img src={downwardArrow} className=" w-12 -mt-2 ml-4 lg:hidden "/>
          </div>
      ...
      <p className='text-red-500 pl-2'>{errors.gender}</p>
              ...
              { values.city && <div>
                ...
                {!showPassword ? (
        <img src={closeEye}   className={`${touched.password && errors.password ? 'w-7 ml-72 lg:ml-80 relative top-[-4.2rem] ' : 'w-7 ml-72 lg:ml-80 relative top-[-2.5rem]'} cursor-pointer`} onClick={togglePasswordVisibility}/>
    ) : (
        <img src={openEye} className='w-7 ml-72 lg:ml-80 relative top-[-2.5rem]  cursor-pointer' onClick={togglePasswordVisibility}/>
    )}
                </div>
...
SUBMIT
          ...
          <div className="bg-[#dddddd]  mt-20 ">
           ...
           <div className="rounded-3xl w-12 h-12 mt-3 mb-4 bg-white flex justify-center  ">
            <img src={shield} className="w-9 h-8 mt-2"/>
          </div>
          <div>
           ...
           <div className="flex gap-3">
           <div className="rounded-3xl w-12 h-12 mt-3 mb-4 bg-white flex justify-center ">
            <img src={rightArrow} className="w-9 h-8 mt-2"/>
          </div>
          <div>
...
SUBMIT
      ...
      <div className=" grid grid-cols-2 sm:grid-cols-3 ml-11 lg:flex lg:gap-7 lg:ml-44 mt-8 localSingles localArray ">
        {
         checkDataArray?.length>0? checkDataArray?.slice(0,7).map(checkItem=>{
            ...
            return (
              ...
              <img src={checkItem.images[0]} className="w-32 h-40  rounded-lg cursor-pointer"/>
              <div className="flex gap-3">
     ...
     <div className="rounded-full border-2 dateWork  border-gray-400  mt-4 mb-8 lg:w-[68rem] lg:ml-40">
      ...
      <div className="mt-6 mb-6">
        <img src={createProfile} className="w-12 ml-12"/>
      ...
      <img src={rightArrows} className="w-4 "/>
      </div>
      
      <div className="mt-6 mb-6">
        <img src={date} className="w-12"/>
