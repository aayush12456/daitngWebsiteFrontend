...
<div ref={ref} className="bg-[#ffffae] overflow-x-hidden overflow-y-hidden">
      <p className="text-[25px] text-center text-black font-bold pt-12">
        Meet genuine singles and find your match!
      </p>
      <div className="flex justify-center">
        <div className="grid grid-cols-3 mt-7 gap-8">
          <motion.div
            className="w-72 rounded overflow-hidden shadow-lg bg-white"
            initial={{ x: -500, opacity: 0 }}
            animate={isInView ? { x: 0, opacity: 1 } : { x: -500, opacity: 0 }}
            transition={{ duration: 1 }}
          >
            <img src={location} className="" />
            <p className="text-center pt-4 pb-4 text-lg">
          ...
          >
            ...
            <p className="text-center pt-4 pb-4 text-lg">
              ...
              <span className="font-semibold text-lg"> Match or make new Friends via MatchMaker</span>
            </p>
          </motion.div>
          <motion.div
            className="w-72 rounded overflow-hidden shadow-lg bg-white"
